...
def reanimatedCmakeStaging = System.getenv("LOCALAPPDATA") != null ? file("${System.getenv('LOCALAPPDATA')}/ReactNativeCxx/NotasAppReanimated") : file("${System.getProperty('java.io.tmpdir')}/NotasAppReanimated-cxx")
...
android {
    ...
    externalNativeBuild {
        cmake {
            path "CMakeLists.txt"
            buildStagingDirectory reanimatedCmakeStaging
        }
    }
    buildTypes {
        debug {
